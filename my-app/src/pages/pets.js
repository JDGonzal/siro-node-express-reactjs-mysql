...
import { REACT_APP_API_URL,REACT_APP_PHOTO_URL  } from '../utils/variables.js';
...
export class Pets extends Component{
  ...
  onChangeDepartmentIdFilter=(e)=>{
    // this.setState({DepartmentIdFilter:e.target.value}) //This Option not work, it is necessary to use the mutate state directly
    // eslint-disable-next-line react/no-direct-mutation-state
    this.state.DepartmentIdFilter=e.target.value;
    this.FilterFn();
  }

  onChangeDepartmentNameFilter=(e)=>{
    // this.setState({DepartmentNameFilter:e.target.value}) //This Option not work, it is necessary to use the mutate state directly
    // eslint-disable-next-line react/no-direct-mutation-state
            ...
            <tr>
              <th>
                <div className="d-flex flex-row">
                  <input className="form-control m-2" onInput={this.onChangeDepartmentIdFilter} placeholder="Filter"/>
              ...
              <th>
                <div className="d-flex flex-row">
                  <input className="form-control m-2" onInput={this.onChangeDepartmentNameFilter} placeholder="Filter"/>
